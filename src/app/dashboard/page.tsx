  ...
  return (
    <div className='h-full'>
      ...
      <div className="grid h-1/2 grid-cols-2 justify-items-center gap-10 m-6">
        <div className="dash-options">Column 1</div>
        <div className="dash-options">Column 2</div>
        <div className="dash-options">Column 3</div>
        <div className="dash-options">Column 4</div>
      </div>
    </div>
  )
}
